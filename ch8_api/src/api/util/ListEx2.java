...
public class ListEx2 {
    public static void main(String[] args) {
        ...
        System.out.println("리스트안에 특정 단어 포함 여부 " + list.contains("키위"));
        System.out.println("리스트안에 특정 단어 포함 위치 " + list.indexOf("자몽"));
        ...
        // 배열에서 리스트로 변환된것이기에 리스트 내부의 요소는 변경불가 조회만가능

        // 배열 => 리스트 변환(조회 + 변경) new로 생성
