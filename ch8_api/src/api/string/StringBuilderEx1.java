...
public class StringBuilderEx1 {
    public static void main(String[] args) {
        ...
        // String 원본 문자열 변경 불가이미에 매번 기존의 메모리를 해제하고 재생성하게됨
        String str1 = "안녕하세요";
        str1 += "반갑습니다.";
        str1 += "저는 홍길동 입니다.";
        ...
        System.out.println("sb1.delete(0,2) : " + sb1.deleteCharAt(0));
        System.out.println(sb1); // 원본 변경이 되었으므로 lo만 출력됨
        System.out.println("sb1.insert(0,H) : " + sb1.insert(0, "H"));

        // SringBuffer의 replace()
        System.out.println("sb1.replace() : " + sb1.replace(0, 2, "java"));
